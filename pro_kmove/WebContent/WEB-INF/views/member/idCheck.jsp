...
<body>
	<c:if test="${check > 0 }">
		<div align="center">
			이미 사용중인 아이디 입니다.
			<form action="${root}/member/idCheck.do" method="post" name="memberCheckForm">
				<input type="text" name="id"/>
				<input type="button" value="확인" onclick="idCheckCheck('${root}', memberCheckForm)" />
	...
	<c:if test="${check==0}">
			<div align="center">
				사용가능한 아이디 입니다.
				<input type="text" name="Checkid" value="${id}" />
