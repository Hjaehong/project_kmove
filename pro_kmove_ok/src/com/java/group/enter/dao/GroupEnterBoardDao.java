...
public class GroupEnterBoardDao {
	...
	public List<GroupEnterBoardDto> myBoardList(String id) {
		List<GroupEnterBoardDto> myList = null;
		try {
			session = sqlSessionFactory.openSession();
			myList = session.selectList("myList", id);
		} catch (Exception e) {
			e.printStackTrace();
		}finally {
			session.close();
	...
	public GroupEnterBoardDto toGetSub(int board_number) {
		GroupEnterBoardDto getSub = null;
		try {
			session = sqlSessionFactory.openSession();
			getSub = session.selectOne("getSub", board_number);
		} catch (Exception e) {
			e.printStackTrace();
		}finally {
			session.close();
	...
	public GroupEnterBoardDto pick(int board_number) {
		GroupEnterBoardDto GEdt = null;
		
		try {
			session = sqlSessionFactory.openSession();
			GEdt = session.selectOne("pickBoard", board_number);
		}catch(Exception e) {
			e.printStackTrace();
		}finally {
			session.close();
