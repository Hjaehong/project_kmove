...
<body>
	<nav class="menu">
		<div class="search">
			<input type="text" placeholder="Search"> <input type="image"
				src="${root}/img/click1.png" alt="검색">
		</div>
		<div class="contents">
			<a href="${root}/main.jsp"><span><img alt="로고	"
					src="${root}/img/logo3.png" alt="메인로고"></span></a> <a
				href="${root}/groupPurchase/list.do" class=on><span>공동구매</span></a>
			<a href="#"><span>해외직구</span></a> <a href="#"><span>주문제작</span></a>
			<a href="#"><span>자유게시판</span></a> <a href="${root}/member/login.do"><span>로그인</span></a>
			<a href="${root}/member/register.do"><span>회원가입</span></a> <span></span>
		</div>
	</nav>
	<div class="wrap">
		<div class="main">
			...
			<div class="top">
				<div class="check">
					<a href="#">시간임박순</a> <a href="#">인원마감순</a> <a href="#">최신순</a> <a
						href="#">인기순</a>
				</div>
				<div class="page_top">
					...
					<c:if test="${startPage > pageBlock}">
						<a
							href="${root}/groupPurchase/list.do?pageNumber=${startPage-pageBlock}">[이전]</a>
					</c:if>
					...
					<c:if test="${endPage < pageCount}">
						<a
							href="${root}/groupPurchase/list.do?pageNumber=${startPage+pageBlock}">[다음]</a>
					</c:if>
				</div>
			</div>
			<div class="card_box">
			...
			<table width="1060" align="center">
				<div>
					<tr>
						<td align="right" bgcolor="D1DBDB"><a href="${root}/groupPurchase/write.do">글쓰기</a></td>
					</tr>
				</div>
			</table>
		</div>
