...
<body>
	<nav class="menu">
		...
		<div id="contents">
			...
			<a href="${root}/member/login.do"><span>공동구매</span></a>
			<a href="${root}/member/login.do" ><span>해외직구</span></a>
			<a href="${root}/member/login.do" ><span>주문제작</span></a>
			<a href="${root}/member/login.do" ><span>자유게시판</span></a>
